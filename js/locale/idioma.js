...
function getLocale() {
  ...
  function cargarTextos(){
    ...
    try{
      document.getElementById("besto_menu_1").innerHTML = polyglot.t("besto_menu_1");
      document.getElementById("besto_menu_2").innerHTML = polyglot.t("besto_menu_1");
      document.getElementById("besto_menu_3").innerHTML = polyglot.t("besto_menu_1");
      document.getElementById("besto_menu_4").innerHTML = polyglot.t("besto_menu_1");
